...
public class java12 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println(" <form action=\"./java12\" method=\"get\">"
            ...
            try {
                ...
                db_st = db_con.prepareStatement("UPDATE test_table SET name=?,age=?,tel=?,birthday=?  WHERE profilesID = ?;");
                db_st.setInt(5,ID );
